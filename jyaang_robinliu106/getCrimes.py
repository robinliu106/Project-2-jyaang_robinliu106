...
class getCrimes(dml.Algorithm):
    ...
    reads = []
    writes = ['alice_bob.crime', 'alice_bob.found']
    ...
    def execute(trial = False):
        ...
        repo['alice_bob.crime'].insert_many(a)
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:alice_bob#getCrimes', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        crime = doc.entity('dat:alice_bob#crime', {prov.model.PROV_LABEL:'Crime Locations', prov.model.PROV_TYPE:'ont:DataSet'})
